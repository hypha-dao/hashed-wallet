...
class AddressIconDataWithMnemonic extends _AddressIconDataWithMnemonic {
  static AddressIconDataWithMnemonic fromJson(Map<String, dynamic> json) => _$AddressIconDataWithMnemonicFromJson(json);
...
class AddressIconData extends _AddressIconData {
  static AddressIconData fromJson(Map<String, dynamic> json) => _$AddressIconDataFromJson(json);
