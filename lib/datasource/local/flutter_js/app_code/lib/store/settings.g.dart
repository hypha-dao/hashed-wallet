...
mixin _$SettingsStore on _SettingsStore, Store {
  ...
  final _$communityMessagesAtom = Atom(name: '_SettingsStore.communityMessages');
  ...
  final _$communityUnreadNumberAtom = Atom(name: '_SettingsStore.communityUnreadNumber');
  ...
  final _$systemUnreadNumberAtom = Atom(name: '_SettingsStore.systemUnreadNumber');
  ...
  final _$tokenStakingConfigAtom = Atom(name: '_SettingsStore.tokenStakingConfig');
  ...
  final _$setCommunityMessagesAsyncAction = AsyncAction('_SettingsStore.setCommunityMessages');

  @override
  Future<void> setCommunityMessages(Map<String, List<MessageData>> data) {
    return _$setCommunityMessagesAsyncAction.run(() => super.setCommunityMessages(data));
  }

  final _$setSystemMessagesAsyncAction = AsyncAction('_SettingsStore.setSystemMessages');

  @override
  Future<void> setSystemMessages(List<MessageData> data) {
    return _$setSystemMessagesAsyncAction.run(() => super.setSystemMessages(data));
  }

  final _$setCommunityUnreadNumberAsyncAction = AsyncAction('_SettingsStore.setCommunityUnreadNumber');

  @override
  Future<void> setCommunityUnreadNumber(Map<String, int> data) {
    return _$setCommunityUnreadNumberAsyncAction.run(() => super.setCommunityUnreadNumber(data));
  }

  final _$setSystemUnreadNumberAsyncAction = AsyncAction('_SettingsStore.setSystemUnreadNumber');

  @override
  Future<void> setSystemUnreadNumber(int data) {
    return _$setSystemUnreadNumberAsyncAction.run(() => super.setSystemUnreadNumber(data));
  }

  final _$setTokenStakingConfigAsyncAction = AsyncAction('_SettingsStore.setTokenStakingConfig');

  @override
  Future<void> setTokenStakingConfig(Map data) {
    return _$setTokenStakingConfigAsyncAction.run(() => super.setTokenStakingConfig(data));
  }
  ...
  final _$setIsHideBalanceAsyncAction = AsyncAction('_SettingsStore.setIsHideBalance');

  @override
  Future<void> setIsHideBalance(bool hide) {
    return _$setIsHideBalanceAsyncAction.run(() => super.setIsHideBalance(hide));
  }

  final _$loadIsHideBalanceAsyncAction = AsyncAction('_SettingsStore.loadIsHideBalance');
