...
mixin _$AccountStore on _AccountStore, Store {
  ...
  final _$walletConnectPairingAtom = Atom(name: '_AccountStore.walletConnectPairing');
  ...
  void setAccountCreated() {
    final _$actionInfo = _$_AccountStoreActionController.startAction(name: '_AccountStore.setAccountCreated');
    try {
  ...
  void setWCPairing(bool pairing) {
    final _$actionInfo = _$_AccountStoreActionController.startAction(name: '_AccountStore.setWCPairing');
    try {
  ...
  void setWCSessions(List<WCPairedData> sessions) {
    final _$actionInfo = _$_AccountStoreActionController.startAction(name: '_AccountStore.setWCSessions');
    try {
  ...
  void createWCSession(WCPairedData session) {
    final _$actionInfo = _$_AccountStoreActionController.startAction(name: '_AccountStore.createWCSession');
    try {
  ...
  void deleteWCSession(WCPairedData session) {
    final _$actionInfo = _$_AccountStoreActionController.startAction(name: '_AccountStore.deleteWCSession');
    try {
