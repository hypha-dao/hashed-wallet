...
class AppUI {
  ...
  static Future<void> checkUpdate(BuildContext context, Map versions, BuildTargets buildTarget,
    ...
    if ((autoCheck ? latestCode : latestCodeBeta) > await Utils.getBuildNumber()) {
      // new version found
    ...
    final showLatestBeta = needUpdate ? latestBeta : await Utils.getAppVersion();
                ...
                child: Center(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.only(top: needUpdate ? 92 : 69, bottom: 20, left: 19, right: 19),
                      width: double.infinity,
                      height: (MediaQuery.of(context).size.width - 96) / 294 * (needUpdate ? 421 : 298),
                      decoration: BoxDecoration(
                        ...
                        image:
                            needUpdate ? DecorationImage(image: AssetImage("assets/images/update_app_bg.png")) : null,
                      ),
                      child: Column(
                        children: [
                          Text(
                            ...
                            style:
                                Theme.of(context).textTheme.headline3?.copyWith(fontSize: UI.getTextSize(28, context)),
                          ),
                          Padding(
                          ...
                          GestureDetector(
                              onTap: () {
                                ...
                                if (Platform.isIOS) {
                                  ...
                                  try {
                                    UpdateApp.updateApp(url: versions['android']['url'], appleId: "1520301768");
                                    showCupertinoDialog(
                                        context: context,
                    ...
                    GestureDetector(
                        ...
                        child: Container(
                            margin: EdgeInsets.only(top: 134, left: needUpdate ? 212 : 230),
                            child: Image.asset("assets/images/update_app_delete.png", width: 24))),
                  ],
                ))));
      },
    );
        ...
        final bool isOk = await showCupertinoDialog(
          ...
          builder: (BuildContext context) {
            return CupertinoAlertDialog(
              ...
              content: Text(I18n.of(context).getDic(i18n_full_dic_app, 'profile')['update.js.up']),
              actions: <Widget>[
                CupertinoButton(
  ...
  static Future<bool> updateJSCode(
    ...
    await showCupertinoDialog(
      ...
      builder: (BuildContext context) {
        return CupertinoAlertDialog(
          title: Container(),
          content: code == null ? Text(dic['update.error']) : Text(dicCommon['success']),
          actions: <Widget>[
            CupertinoButton(
  ...
  static bool checkBalanceAndAlert(BuildContext context, BalanceData balance, BigInt amountNeeded) {
    if (Fmt.balanceInt(balance.availableBalance.toString()) <= amountNeeded) {
      showCupertinoDialog(
        context: context,
        builder: (BuildContext context) {
          return CupertinoAlertDialog(
            title: Text(I18n.of(context).getDic(i18n_full_dic_app, 'assets')['amount.low']),
            content: Container(),
            actions: <Widget>[
              CupertinoButton(
                child: Text(I18n.of(context).getDic(i18n_full_dic_ui, 'common')['ok']),
