...
//     final res = await widget.service.plugin.sdk.api.walletConnect.signPayload(args, password);
//     if (mounted) {
//       setState(() {
//         _submitting = false;
//       });
...
//     final WCPayloadData args = ModalRoute.of(context).settings.arguments;
//     final session = widget.service.store.account.wcSessions.firstWhere((e) => e.topic == args.topic);
...
//     return Scaffold(
//       appBar: AppBar(
//           title: Text(dic[args.payload.method == 'signExtrinsic' ? 'submit.sign.tx' : 'submit.sign.msg']),
//           centerTitle: true,
//           leading: BackBtn()),
//       body: SafeArea(
//         child: Column(
...
//                     child: AddressFormItem(acc, svg: acc.icon, label: dic['submit.signer']),
//                   ),
...
//                     child: TextButton(
//                       style: ButtonStyle(padding: MaterialStateProperty.all(EdgeInsets.all(16))),
...
//                 Expanded(
//                   child: Container(
//                     color: _submitting ? Theme.of(context).disabledColor : Theme.of(context).primaryColor,
//                     child: TextButton(
//                       style: ButtonStyle(padding: MaterialStateProperty.all(EdgeInsets.all(16))),
//                       child: Text(
//                         dic['submit.sign'],
...
//                       ),
//                       onPressed: _submitting ? null : () => _showPasswordDialog(acc),
//                     ),
//                   ),
//                 ),
//               ],
