...
//     return Scaffold(
//       appBar: AppBar(
//           title: Image.asset('assets/images/wallet_connect_banner.png', height: 24),
//           centerTitle: true,
//           leading: BackBtn()),
//       body: SafeArea(
//         child: Column(
...
//                 Expanded(
//                   child: Container(
//                     color: _submitting ? Theme.of(context).disabledColor : Colors.orange,
//                     child: TextButton(
//                       style: ButtonStyle(padding: MaterialStateProperty.all(EdgeInsets.all(16))),
//                       child: Text(dic['wc.reject'], style: TextStyle(color: Colors.white)),
