...
class RemoteNodeListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    endpoints.asMap().forEach((k, i) {
      final isCurrent = service.plugin.sdk.api.connectedNode?.endpoint == i.endpoint;
    ...
    return Scaffold(
      appBar: AppBar(title: Text(dic['setting.node.list']), centerTitle: true, leading: BackBtn()),
      body: SafeArea(
