...
class _ChangeName extends State<ChangeNamePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(dic['name.change']), centerTitle: true, leading: BackBtn()),
      body: SafeArea(
        child: Column(
          children: <Widget>[
            Expanded(
                  ...
                  child: Form(
                    ...
                    child: v3.TextInputWidget(
                      ...
                      validator: (v) {
                        ...
                        int exist = widget.service.keyring.optionals.indexWhere((i) => i.name == name);
                        if (exist > -1) {
              ...
              child: Button(
                ...
                onPressed: () {
                  if (_formKey.currentState.validate()) {
                    widget.service.plugin.sdk.api.keyring.changeName(widget.service.keyring, _nameCtrl.text.trim());
