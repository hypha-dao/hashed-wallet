...
class _SignMessagePageState extends State<SignMessagePage> with SingleTickerProviderStateMixin {
  ...
  void _onSign() async {
    if (_formKey.currentState.validate()) {
      ...
      final res = await widget.service.plugin.sdk.api.keyring.signAsExtension(password, params);
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(dic['sign']), centerTitle: true, leading: BackBtn()),
      body: SafeArea(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: GestureDetector(
                          ...
                          onTap: _signResCtrl.text.isEmpty ? null : () => UI.copyAndNotify(context, _signResCtrl.text),
                        ),
                      ),
                      Container(
                    ...
                    children: [
                      Container(
                        ...
                        child: AddressTextFormField(
                          ...
                          initialValue: _verifySigner ?? widget.service.keyring.current,
                      ...
                      Container(
                        ...
                        child: InfoItemRow('isValid', '${_verifyResult.isValid ?? '-'}'),
                      ),
                      Container(
                        margin: EdgeInsets.fromLTRB(14.w, 4.h, 12.w, 0),
                        child: InfoItemRow('crypto', '${_verifyResult.crypto ?? '-'}'),
                      ),
                      Container(
