...
class _CommunityPage extends State<CommunityPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(dic['community']), centerTitle: true, leading: BackBtn()),
      body: SafeArea(
                ...
                child: Column(
                  children: [
                    ...
                    SettingsPageListItem(
                      ...
                      onTap: () => UI.launchURL('https://twitter.com/AcalaNetwork'),
                    ),
                    Divider(),
                    SettingsPageListItem(
                      label: 'Telegram',
                    ...
                    SettingsPageListItem(
                      ...
                      onTap: () => UI.launchURL('https://linktr.ee/acalanetwork'),
                    ),
                  ],
                ),
              ),
