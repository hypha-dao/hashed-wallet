...
class _AccountManagePageState extends State<AccountManagePage> {
  ...
  Future<void> _onDeleteAccount(BuildContext context) async {
    ...
    if (password != null) {
      widget.service.plugin.sdk.api.keyring
        ...
        widget.service.store.assets.loadCache(widget.service.keyring.current, widget.service.plugin.basic.name);
      });
  ...
  Future<void> _checkBiometricAuth() async {
    ...
    // final pubKey = widget.service.keyring.current.pubKey;
    // final storeFile = await widget.service.account.getBiometricPassStoreFile(context, pubKey);
    // final isAuthorized = !widget.service.account.isCloseBiometricDisabled(pubKey);
    // setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(dic['account']), centerTitle: true, elevation: 0.0, leading: BackBtn()),
      body: SafeArea(
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                              fontSize: UI.getTextSize(16, context), color: Theme.of(context).unselectedWidgetColor),
                        ),
                        GestureDetector(
                          child: Container(
              ...
              RoundedCard(
                ...
                child: Column(
                  children: [
                    ...
                    Divider(height: 24.h),
                    SettingsPageListItem(
                      label: I18n.of(context).getDic(i18n_full_dic_app, 'account')['unlock.bio.enable'],
