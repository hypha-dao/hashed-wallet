...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _manageAccount() async {
    if (widget.service.keyring.current.observation ?? false) {
      await Navigator.pushNamed(context, ContactPage.route, arguments: widget.service.keyring.current);
    } else {
  ...
  void _showRecoveryMenu(BuildContext context) {
    final Map<String, String> dic = I18n.of(context).getDic(i18n_full_dic_app, 'profile');
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage("packages/polkawallet_ui/assets/images/icon_bg_grey.png"),
                          fit: BoxFit.fill)),
                  child: Stack(
                    ...
                    children: [
                      Container(
                          ...
                          child: Center(
                            child: Image.asset("assets/images/message.png", width: 24.h),
                          )),
                      Visibility(
                          visible: communityUnreadNumber + systemUnreadNumber > 0,
                          child: Container(
                            width: 9.h,
                            height: 9.h,
                            margin: EdgeInsets.only(right: 1, top: 1),
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(4.5.h), color: Theme.of(context).errorColor),
                          ))
                    ],
                  ),
                ));
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: AddressIcon(acc.address, svg: acc.icon, size: 60.w),
                            ),
                            Expanded(
                              child: Column(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: TextStyle(fontSize: UI.getTextSize(16, context), color: grey),
                                      ),
                                      GestureDetector(
                                          child: Container(
                                          ...
                                          onTap: () => Navigator.pushNamed(context, AccountQrCodePage.route))
                                    ],
                                  )
                                ],
                              ),
                            ...
                            Container(
                              ...
                              child: Image.asset('assets/images/icons/arrow_forward.png', width: 30.w),
                            ),
                          ],
                        ),
                      ],
                ...
                child: Column(
                  children: [
                    ...
                    SettingsPageListItem(
                      ...
                      content: widget.connectedNode == null ? CupertinoActivityIndicator(radius: 8) : null,
                ...
                child: Column(
                  children: [
                        ...
                        ? Column(
                            children: [
                              SettingsPageListItem(
                                ...
                                label: dic['community'],
                                onTap: () => Navigator.of(context).pushNamed(CommunityPage.route),
                              ),
                              Divider()
                            ],
                          )
                    ...
                    SettingsPageListItem(
                      ...
                      label: dic['guide'],
                      onTap: () => UI.launchURL('https://wiki.polkawallet.app/'),
                    )
                  ],
                ),
              ),
...
class SettingsPageListItem extends StatelessWidget {
  SettingsPageListItem({this.leading, this.label, this.subtitle, this.content, this.onTap});
        ...
        children: [
          Visibility(
            ...
            child: Container(
              ...
              child: leading,
              decoration: BoxDecoration(color: Color(0xFFCECECE), borderRadius: BorderRadius.all(Radius.circular(8.r))),
            ),
          ),
          Expanded(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  subtitle != null ? Text(subtitle, style: Theme.of(context).textTheme.headline6) : Container(),
                ],
              ),
            ),
          ),
          ...
          onTap != null ? Image.asset('assets/images/icons/arrow_forward.png', width: 24.w) : Container(width: 1),
        ],
      ),
      onTap: onTap,
    );
