...
import 'package:seeds/datasource/local/flutter_js/app_code/lib/common/components/txList.dart';
            ...
            children: [
              ...
              Padding(
                ...
                child: RoundedButton(
                  ...
                  onPressed: () async {
                    final res = await Navigator.of(context).pushNamed(VouchRecoveryPage.route);
                    if (res != null) {
                      _refreshKey.currentState.show();
                    }
                  },
