...
class _ContactsPageState extends State<ContactsPage> {
        ...
        actions: <Widget>[
          CupertinoActionSheetAction(
            ...
            onPressed: () async {
              ...
              await Navigator.of(context).pushNamed(ContactPage.route, arguments: i);
              _refreshData();
            },
          ),
          CupertinoActionSheetAction(
    ...
    showCupertinoDialog(
      ...
      builder: (BuildContext context) {
        return CupertinoAlertDialog(
          title: Text(I18n.of(context).getDic(i18n_full_dic_app, 'profile')['contact.delete.warn']),
          ...
          actions: <Widget>[
            ...
            CupertinoButton(
              ...
              onPressed: () async {
                ...
                if (i.observation && widget.service.keyring.store.currentPubKey == i.pubKey) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text(I18n.of(context).getDic(i18n_full_dic_app, 'profile')['contact']),
          centerTitle: true,
          actions: <Widget>[
            Padding(
