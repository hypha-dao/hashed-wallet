...
class EcosystemPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final index = banner.indexWhere((element) => element["network"] == service.plugin.basic.name);
    ...
    final tokenXcmFromConfig = List<String>.from((tokensConfig['xcmFrom'] ?? {})[balance.tokenNameId] ?? []);
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    ...
                    style: Theme.of(context).textTheme.headline3?.copyWith(color: PluginColorsDark.headline1),
                  ),
                  Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          PluginOutlinedButtonSmall(
                            ...
                            active: true,
                            onPressed: () =>
                                Navigator.of(context).popUntil((route) => route.settings.name == TokenStaking.route),
                          ),
                          Visibility(
                              visible: type == "transferred" ||
                                  (tokenXcmConfig.length > 0 && convertNetwork == service.plugin.basic.name) ||
                                  (tokenXcmFromConfig.length > 0 && convertNetwork != service.plugin.basic.name),
                              child: PluginOutlinedButtonSmall(
                                ...
                                onPressed: () {
                                  if (type == "transferred") {
                                    ...
                                    Navigator.of(context).popAndPushNamed(CrossChainTransferPage.route,
                                        arguments: {"balance": balance, "fromNetwork": convertNetwork});
                                  }
                                },
                              )),
                        ],
