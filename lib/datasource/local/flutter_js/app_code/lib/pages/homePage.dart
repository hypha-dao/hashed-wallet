...
import 'package:seeds/datasource/local/flutter_js/app_code/lib/pages/assets/index.dart';
...
import 'package:seeds/datasource/local/flutter_js/app_code/lib/utils/BottomNavigationBar.dart';
...
class HomePage extends StatefulWidget {
  HomePage(this.service, this.plugins, this.connectedNode, this.checkJSCodeUpdate, this.switchNetwork, this.changeNode);

  final AppService service;
  final NetworkParams connectedNode;
  final Future<void> Function(BuildContext, PolkawalletPlugin, {bool needReload}) checkJSCodeUpdate;
  final Future<void> Function(String, {NetworkParams node, PageRouteParams pageRoute}) switchNetwork;
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _setupJPush() async {
    ...
    _jPush.applyPushAuthority(new NotificationSettingsIOS(sound: true, alert: true, badge: false));
        ...
        showCupertinoDialog(
            ...
            builder: (_) {
              return CupertinoAlertDialog(
                content: Text(I18n.of(context).getDic(i18n_full_dic_app, 'public')['wss.timeout']),
              );
            });
          ...
          child: Column(children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: Theme.of(context)
                          .textTheme
                          .headline4
                          .copyWith(fontSize: UI.getTextSize(14, context), color: Colors.white),
                    ),
                  )
                ],
              ),
            ...
            Container(
                ...
                decoration: BoxDecoration(
                    color: Color.fromARGB(36, 255, 255, 255), borderRadius: BorderRadius.all(Radius.circular(4))),
                ...
                child: Text(
                  ...
                  style: Theme.of(context)
                      .textTheme
                      .headline1
                      .copyWith(fontSize: UI.getTextSize(20, context), color: Theme.of(context).errorColor),
                ))
          ]),
          onTap: () {
        ...
        GestureDetector(
          child: Column(children: [
            Expanded(
              ...
              child: Column(
                children: [
                  Image.asset('assets/images/public/hub_token_staking_$token.png'),
                  Container(
                    padding: EdgeInsets.only(top: 16),
                    child: Text(
            ...
            if (token == "DOT") {
              if (widget.service.plugin.basic.name != para_chain_name_acala) {
                widget.service.plugin.appUtils.switchNetwork(
                  ...
                  pageRoute: PageRouteParams(TokenStaking.route, args: {"token": token}),
                );
                return;
              }
            } else {
  ...
  Widget build(BuildContext context) {
    final List<HomeNavItem> pages = [
      HomeNavItem(
        ...
        content: AssetsPage(widget.service, widget.plugins, widget.connectedNode, (PolkawalletPlugin plugin) async {
          _setupWssNotifyTimer();
    ...
    final pluginPages = widget.service.plugin.getNavItems(context, widget.service.keyring);
    if (pluginPages.length > 1 || (pluginPages.length == 1 && pluginPages[0].isAdapter)) {
      ...
      pluginPages.forEach((element) {
        if (element.isAdapter) {
          ...
          final coverName = coverIndex > 3 ? metaHubCovers[coverIndex - 4] : element.text.toLowerCase();
                  ...
                  children: coverIndex > -1
                      ? [
                          Expanded(
                            ...
                            child: Column(
                              children: [
                                Image.asset('assets/images/public/hub_$coverName.png'),
                                Container(
                                  padding: EdgeInsets.only(top: 16),
                                  child: Text(
                          ...
                          Container(
                              ...
                              child: Text(
                                ...
                                style: Theme.of(context).textTheme.headline1.copyWith(
                                    fontSize: UI.getTextSize(20, context), color: Theme.of(context).errorColor),
                              ))
                        ]
                      : [
                          PluginItemCard(
      ...
      pages.add(HomeNavItem(
          ...
          text: I18n.of(context).getDic(i18n_full_dic_app, 'public')['v3.metahub']));
    } else {
      pages.add(HomeNavItem(
      ...
      body: Stack(
        ...
        children: [
          PageView(
            ...
            children: pages
                .map((e) => widget.service.plugin.basic.name == para_chain_name_acala &&
                        e.text == I18n.of(context).getDic(i18n_full_dic_app, 'public')['v3.metahub']
                    ? e.content
          ...
          Observer(builder: (_) {
            final walletConnectAlive = widget.service.store.account.wcSessions.length > 0;
            final walletConnecting = widget.service.store.account.walletConnectPairing;
            return Visibility(
                ...
                child: Container(
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: walletConnectAlive
                        ? () {
                            // Navigator.of(context).pushNamed(WCSessionsPage.route);
                          }
                        : () => null,
                  ),
                ));
