            ...
            child: Stack(alignment: Alignment.bottomCenter, children: [
              PageView(
                ...
                children: _pages
                    .map(
                      (e) => Column(
                        children: [Image.asset('assets/images/public/guide_$e.png')],
                      ),
                    )
                    .toList(),
              ),
                ...
                Container(
                    ...
                    child: Text(
                      ...
                      style: Theme.of(context)
                          .textTheme
                          .headline1
                          .copyWith(fontSize: UI.getTextSize(28, context), height: 1.15),
                    )),
                Padding(
                                    ...
                                    color: i == _pageIndex
                                        ? _pageIndex == 0
                                            ...
                                            : _pageIndex == 1
                                                ...
                                                : Color(0xFF768FE1)
                                        : Color(0xFFD5D2CD),
                                    borderRadius: BorderRadius.all(Radius.circular(19 / 2.0))),
                              ))
                          .toList(),
                    )),
                Padding(
                    ...
                    child: Button(
                      title: _pageIndex + 1 >= _pages.length ? dic['guide.enter'] : dic['guide.next'],
                      onPressed: () {
