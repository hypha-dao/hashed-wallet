...
class BrowserApi {
  ...
  static Future openBrowser(BuildContext context, dynamic dapp, AppService service) async {
    ...
    return await Navigator.of(context).pushNamed(
      ...
      arguments: {"url": dapp['detailUrl'], "isPlugin": true, "icon": dapp["icon"]},
    );
  }
  ...
  static List<dynamic> getDappLatest(AppService service) {
    ...
    dappLatest.forEach((key, value) {
      var data = service.store.settings.dapps.firstWhere((element) => element["name"] == key);
