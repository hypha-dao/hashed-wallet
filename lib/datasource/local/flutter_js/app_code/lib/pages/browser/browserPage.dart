...
import 'package:seeds/datasource/local/flutter_js/app_code/lib/pages/browser/browserSearch.dart';
...
import 'package:seeds/datasource/local/flutter_js/app_code/lib/pages/browser/search.dart' as search;
...
class _BrowserPageState extends State<BrowserPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final dapps = _tag == 0
        ...
        : widget.service.store.settings.dapps
            .where((e) => e["tag"].join(" #").contains(widget.service.store.settings.dappAllTags[_tag - 1]))
            .toList();
                            ...
                            onTap: () async {
                              final result = await search.showSearch(
                                  ...
                                  delegate: SearchBarDelegate(widget.service,
                                      searchFieldLabel: dic['hub.browser.search'],
                                      searchFieldStyle:
                                          Theme.of(context).textTheme.headline5?.copyWith(color: Color(0x80FFFFFF))));
                              if (result != null) {
                                setState(() {});
                              }
                            },
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                        Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                                onTap: () async {
                                  final re = await Navigator.of(context).pushNamed(DappLatestPage.route);
                                  if (re != null) {
                                    setState(() {});
                                  }
                                },
                                ...
                                child: ListView.separated(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return GestureDetector(
                                          onTap: () {
                                            BrowserApi.openBrowser(context, e, widget.service)
                                                .then((value) => setState(() {}));
                                          },
                                          child: Container(
                                            child: Column(
                  ...
                  Container(
                      ...
                      child: ListView.separated(
                          scrollDirection: Axis.horizontal,
                          separatorBuilder: (context, index) => Container(width: 6),
                          itemCount: widget.service.store.settings.dappAllTags.length + 1,
                          itemBuilder: (context, index) {
                            return GestureDetector(
                                onTap: () {
                                  if (_tag != index) {
                                ...
                                child: Container(
                                    child: Text(
                                      index == 0 ? "all" : widget.service.store.settings.dappAllTags[index - 1],
                                      style: Theme.of(context).textTheme.headline5?.copyWith(
                                          fontSize: UI.getTextSize(12, context),
                                          fontWeight: _tag == index ? FontWeight.w600 : FontWeight.w400,
                                          color: _tag == index ? Colors.black : PluginColorsDark.headline1),
                                    ),
                                    padding: EdgeInsets.symmetric(horizontal: 7, vertical: 3),
                                    decoration: BoxDecoration(
                                        color:
                                            _tag == index ? PluginColorsDark.primary : Color(0xFFFFFFFF).withAlpha(43),
                  ...
                  Expanded(
                      child: GridView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return GestureDetector(
                                onTap: () {
                                  BrowserApi.openBrowser(context, dapp, widget.service)
                                      .then((value) => setState(() {}));
                                },
                                child: Container(
                                  padding: EdgeInsets.all(8),
                                  decoration:
                                      BoxDecoration(color: Color(0x24FFFFFF), borderRadius: BorderRadius.circular(6)),
                                  child: Row(
                                    children: [
                                      Container(
                                          width: 32,
                                          ...
                                          child: (dapp["icon"] as String).contains('.svg')
