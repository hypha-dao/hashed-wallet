...
class ImportAccountFormKeyStore extends StatefulWidget {
  ...
  @override
  _ImportAccountFormKeyStoreState createState() => _ImportAccountFormKeyStoreState();
}
...
class _ImportAccountFormKeyStoreState extends State<ImportAccountFormKeyStore> {
                        ...
                        child: Button(
                          ...
                          onPressed: () async {
                            if (_formKey.currentState.validate()) {
                              ...
                              widget.service.store.account.setNewAccount(_nameCtrl.text.trim(), _passCtrl.text.trim());
                              ...
                              if (saved) {
                                ...
                                widget.service.store.assets
                                    .loadCache(widget.service.keyring.current, widget.service.plugin.basic.name);
                                widget.service.store.account.resetNewAccount();
  ...
  Future<void> _refreshAccountAddress(Map keyStore) async {
    final addressInfo = await widget.service.plugin.sdk.api.keyring
        .addressFromKeyStore(widget.service.plugin.basic.ss58, keyStore: keyStore);
    setState(() {
