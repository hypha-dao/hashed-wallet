// @dart=2.9
import 'package:seeds/datasource/local/flutter_js/app_code/lib/pages/account/import/importAccountAction.dart';
...
class _CreateAccountFormState extends State<CreateAccountForm> {
  ...
  Future<void> _onSubmit() async {
    if (_formKey.currentState.validate()) {
      widget.service.store.account.setNewAccount(_nameCtrl.text, _passCtrl.text);
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: v3.TextInputWidget(
                    ...
                    validator: (v) {
                      return AppFmt.checkPassword(v.trim()) ? null : dic['create.password.error'];
                    },
                    obscureText: true,
                  ),
                ),
